...
class Rimplates_Public {
	...
	public function __construct( $plugin_name, $version ) {
        ...
        add_action('display_rimplates_css_inline',  array($this,'display_rimplates_css'), 10, 2 );
	}
	
		
	public function display_rimplates_css($template_id, $user_id) {
	     ...
	     <style>
	         .rp-primary{
	             -class-pri-bg: #0076A5;
	             background:<?php echo $rp_primary_color_bg; ?>;
	             color:<?php echo $rp_primary_color_text; ?>;
	         }
	         .rp-secondary{
	             background:<?php echo $rp_secondary_color_bg; ?>;
	             color:<?php echo $rp_secondary_color_text; ?>;
	         }
	         .rp-primary ul li a {
	             color: <?php echo $rp_primary_color_text; ?>;
	         }
	         .rp-primary ul li.active > a, .rp-primary a[aria-expanded="true"] {
                  background: <?php echo $rp_secondary_color_bg; ?>;
                }
                
            button.rp-secondary{
                 background: <?php echo $rp_secondary_color_bg; ?>!important;
                 color: <?php echo $rp_secondary_color_text; ?>!important;
            }
            
            button.rp-secondary:hover{
                 background:<?php echo $rp_primary_color_bg; ?>!important;
	             color:<?php echo $rp_primary_color_text; ?>!important;
            }
            
            button.rp-secondary:focus{
            ...
            .copyright-rimplates {
                  background: <?php echo $rp_secondary_color_bg; ?>;
                  color: <?php echo $rp_secondary_color_text; ?>;
                  border-top: 1px solid <?php echo $rp_secondary_color_bg; ?>;;
                }
	...
	public function RetrieveTemplate($atts) {
        ...
        $user_id = $atts['user_id'];
         ...
         do_action("display_rimplates_css_inline", $template_id, $user_id);    
