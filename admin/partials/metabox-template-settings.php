<?php
        ...
        $linked_template_page_id = get_post_meta($template_post_id, 'linked_rimplate_page_id', true);
    ...
    <table class="form-table">
          <tbody>
            ...
            <tr>
                ...
                <td><input name="rimplates_small_title" id="rimplates_small_title" type="text" value="<?php echo esc_attr($small_title); ?>" placeholder="RPL" maxlength="3" class="regular-text" required style="width:100%;max-width: 400px; height: 40px;"> </td>
            </tr>
