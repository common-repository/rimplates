...
class RimplatesAdminSidebarMenuSettings {
  ...
  public function tab_manager_dashboard_fxn(){
    ...
    function my_plugin_settings_link($links) { 
      ...
      $url = esc_url('https://rimplates.tawk.help');
      // Create the link.
      $docs_link = "<a href='https://rimplates.tawk.help'  style='color: #93003c;font-weight: 800;' target='_blank'>" . __( 'Docs / Setup Info' ) . '</a>';
