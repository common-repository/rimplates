 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Rimplates Dashboard & Online Web Portal Maker 
 * Plugin URI:        https://rimplates.com
 * Description:       Rimplates is a dashboard maker for wordpress. Using this Plugin is simple, install it, RIMPLATES will appear on your admin dashboard menu (with ability to add / create templates, dashboard ~ it supports both admin dashboard & user dashboard). You display the created templates/dashboard with shortcode, Use shortcode [rimplenet-template id=ID], E.g if your ID is 5 , your valid shortcode will be [rimplenet-template id=5] 
 * Version:           1.0.5
 * Author:            rimplates
 ...
 */
define( 'RIMPLATES_VERSION', '1.0.5' );
